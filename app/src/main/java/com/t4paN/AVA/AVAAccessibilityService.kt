 ...
 *
 * Missed calls used to be read by driving the dialer from here with calibrated
 * coordinate taps and scraping the screen; that now lives in MissedCallsReader,
 * which queries CallLog directly.
 */
class AVAAccessibilityService : AccessibilityService() {
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent?) {
        ...
        if (!VoIPManager.isActive()) return
